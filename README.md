...
O layout foi concebido no **Figma** e implementado em **HTML5** e **CSS3**, com foco em tipografia, contraste, experiência visual e um layout responsivo.
 ...
 O projeto **De Pátria para Pátria** é uma página estática que apresenta uma jornada artística por diferentes regiões do mundo do **Kentucky ao Burundi**, passando pelo **País de Gales** e **Ucrânia**.  
 ...
 **Figma** - design e prototipagem da interface.
 ...
 Usamos o figma no projeto de forma a aprender a trabalhar de criando interfaces digitais com a colaboraçao em tempo real, interativa e com componentes reutilizaveis que agilizam o trabalho em equipe . 
